...
<div class="container" style="width: 256px">
    ...
    <form role="form" enctype="multipart/form-data" class="form-horizontal" action="/doAddContact" method="post">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="homePhone" title="Home Phone" placeholder="Home Phone">
                data-toggle="popover" data-trigger="focus" data-placement="left"></div>
